...
public class PaymentTypeHome {
	...
	public PaymentType merge(PaymentType detachedInstance) {
		...
		try {
			PaymentType result = (PaymentType) sessionFactory
	...
	public PaymentType findById(java.math.BigDecimal id) {
		log.debug("getting PaymentType instance with id: " + id);
		try {
			PaymentType instance = (PaymentType) sessionFactory
					.getCurrentSession().get("PaymentType", id);
			if (instance == null) {
