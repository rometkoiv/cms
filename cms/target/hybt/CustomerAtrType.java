...
/**
 * CustomerAtrType generated by hbm2java
 */
public class CustomerAtrType implements java.io.Serializable {
	...
	public CustomerAtrType() {
	}

	public CustomerAtrType(BigDecimal customerAtrType) {
		this.customerAtrType = customerAtrType;
	}

	public CustomerAtrType(BigDecimal customerAtrType, String name,
