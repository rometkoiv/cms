...
/**
 * Home object for domain model class ContractType.
 * @see .ContractType
 * @author Hibernate Tools
 */
public class ContractTypeHome {

	private static final Log log = LogFactory.getLog(ContractTypeHome.class);
	...
	public void persist(ContractType transientInstance) {
		log.debug("persisting ContractType instance");
		try {
	...
	public ContractType merge(ContractType detachedInstance) {
		...
		try {
			ContractType result = (ContractType) sessionFactory
	...
	public ContractType findById(java.math.BigDecimal id) {
		log.debug("getting ContractType instance with id: " + id);
		try {
			ContractType instance = (ContractType) sessionFactory
					.getCurrentSession().get("ContractType", id);
			if (instance == null) {
	...
	public List findByExample(ContractType instance) {
		log.debug("finding ContractType instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("ContractType")
