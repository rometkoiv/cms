...
/**
 * Home object for domain model class EmpRole.
 * @see .EmpRole
 * @author Hibernate Tools
 */
public class EmpRoleHome {

	private static final Log log = LogFactory.getLog(EmpRoleHome.class);
	...
	public void persist(EmpRole transientInstance) {
	...
	public EmpRole merge(EmpRole detachedInstance) {
		...
		try {
			EmpRole result = (EmpRole) sessionFactory.getCurrentSession()
	...
	public EmpRole findById(java.math.BigDecimal id) {
		log.debug("getting EmpRole instance with id: " + id);
		try {
			EmpRole instance = (EmpRole) sessionFactory.getCurrentSession()
					.get("EmpRole", id);
			if (instance == null) {
	...
	public List findByExample(EmpRole instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("EmpRole").add(Example.create(instance))
					.list();
